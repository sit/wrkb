...
- description: 'The souls of enemy champions that die within 3 seconds of being damaged
    ...
    and items - Heals for 7% ( 2 + 4% bonus AD + 2% AP +5 bonus AS ) of the target''s
...
- cooldowns:
  ...
  description: 'Passive : Attacks deal bonus physical damage equal to 3% / 4% / 5%
    ...
    20 / 40 / 60 / 80 ((+ 80% AD ) * ( 1 + 0.5% bonus Critical rate )) physical damage
...
- cooldowns:
  ...
  description: Sends forth a specter to haunt the first terrain hit with Black Mist
    ...
    25% / 30% / 35% / 40% Movement Speed ( +0.04% AP ) and 45% / 50% / 55% / 60% Attack
    Speed .
  name: Harrowed Path
  slot: '3'
- cooldowns:
  ...
  description: Teleports to a target location nearby, dealing physical damage equal
    to 110% - 210% AD * ( 1 + 0.5 Crit rate ) to all the champions in the area. Deal
    14% / 17% / 20% ( +6% bonus AD ) of the target's missing Health to the enemy champion
...
The souls of enemy champions that die within 3 seconds of being damaged by Viego become wraiths that remain in place for 8 seconds.Viego can channel for 1 second to Possess them for 10 seconds. During Possession: - Becomes untargetable - Gains a free cast of Heartbreaker - Gains 10% Movement Speed when moving toward enemy champions - Gains access to the Possessed champion's basic abilities, attacks and items - Heals for 7% ( 2 + 4% bonus AD + 2% AP +5 bonus AS ) of the target's max Health Viego cannot use the Possessed champion's enchantment item actives.
...
Sends forth a specter to haunt the first terrain hit with Black Mist for 6 seconds. While inside the Black Mist, Viego becomes camouflaged and gains 25% / 30% / 35% / 40% Movement Speed ( +0.04% AP ) and 45% / 50% / 55% / 60% Attack Speed .

### [4] Heartbreaker

**Cooldown:** 90.0 / 75.0 / 60.0 seconds

Teleports to a target location nearby, dealing physical damage equal to 110% - 210% AD * ( 1 + 0.5 Crit rate ) to all the champions in the area. Deal 14% / 17% / 20% ( +6% bonus AD ) of the target's missing Health to the enemy champion with the lowest percentage of Health, slowing them by 99% for 0.25 seconds and knocking back enemies nearby them.
