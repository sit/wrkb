---
abilities:
- description: Stores time as Experience at a rate of 20 / 50 / 80 XP per 5 seconds.
    Zilean can grant this Experience to the nearest allied champion when he has enough
    to complete their next level up by tapping the minion button. Doing so gives Zilean
...
- cooldowns:
  ...
  description: 'Tosses a Time Bomb to a target location. The bomb sticks to the first
    ...
    dealing 70 / 100 / 210 / 280 ( +75% AP ) magic damage to the target and nearby
...
- cooldowns:
  ...
  description: 'Makes time flow faster for himself, applying Fleeting Time to himself
    and gaining a shield that absorbs 45 / 70 / 95 / 120 ( +45% AP ) damage . Zilean
    ...
    is active, his Basic Ability Haste is increased by 80% .'
...
- cooldowns:
  ...
  description: Creates a time-bending force field for 2.5 seconds. While within the
    force field, enemy champions are slowed by 20% / 25% / 30% / 35% ( +5% AP ) and
    projectiles by 80% .
...
- cooldowns:
  ...
  description: Places a protective time rune that lasts 5 seconds on himself or an
    ...
    not trigger the rune's revival effect, 10% of Chronoshift's cooldown will be refunded.
  name: Chronoshift
  slot: '4'
base_stats:
  Armor:
...
Creates a time-bending force field for 2.5 seconds. While within the force field, enemy champions are slowed by 20% / 25% / 30% / 35% ( +5% AP ) and projectiles by 80% .
