...
- "UNIQUE - FERVOR: +5% movement speed\n\r\nUNIQUE - SPELLBLADE: After using an ability,\
  ...
  \ speed for 2 seconds. Bonuses do not stack."
id: 87
...
UNIQUE - Valor: Basic attacks (on-hit) grant +(20 Melee / 10 Ranged) flat movement speed for 2 seconds. Bonuses do not stack.
