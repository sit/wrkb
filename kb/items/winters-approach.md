...
- "UNIQUE - AWE: Grants Ability Haste equal to 1% maximum mana. Refunds 15% of mana\
  ...
  \ Triggers up to 3.3 times every 10 seconds.\n\r\nTransforms into Fimbulwinter Fimbulwinter\
...
UNIQUE - MANA CHARGE: Increases max Mana by 12 every attack, when Mana is spent or when taking damage from champions, epic monsters, or towers. Triggers up to 3.3 times every 10 seconds.
