...
description: 'Basic attacks and abilities generate stacks of Conqueror on enemy champions
  ...
  3 - 5 (based on level) bonus (Adaptive) Attack Damage 4 - 12 (based on level) or
  Ability Power 4 - 8 (based on level), stacking up to 6 times, for a maximum of 12
